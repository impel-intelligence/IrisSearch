...
private typealias Record = DocumentLog.Record
private typealias Header = DocumentLog.Header
...
struct DocumentMapTests {
    ...
    @Test func testRecordEncodesToExactlyByteCount() async throws {
        let record = Record(uuid: uuidA, documentID: 1, startSlot: 0, endSlot: 3, sequence: 1, flags: [.live])
    ...
    @Test func testRecordFieldsLandOnDeclaredOffsets() async throws {
        let record = Record(uuid: uuidA, documentID: 7, startSlot: 3, endSlot: 9, sequence: 5, flags: [.live])
    ...
    @Test func testRecordRoundTrip() async throws {
        let original = Record(uuid: uuidB, documentID: 99, startSlot: 12, endSlot: 40, sequence: 7, flags: [.live])
        let bytes = original.encoded()

        let decoded = try Record(bytes: bytes, at: 0, maximumSlotCount: 1_000)
    ...
    @Test func testDeadRecordRoundTripsAsDead() async throws {
        ...
        let tombstone = Record(uuid: uuidA, documentID: 1, startSlot: 0, endSlot: 3, sequence: 1, flags: .empty)
    ...
    @Test func testRecordDecodesAtANonZeroBase() async throws {
        ...
        let first = Record(uuid: uuidA, documentID: 1, startSlot: 0, endSlot: 3, sequence: 1, flags: [.live])
        let second = Record(uuid: uuidB, documentID: 2, startSlot: 3, endSlot: 6, sequence: 2, flags: [.live])

        var bytes = Header(generation: 0).encoded()
        first.encode(into: &bytes)
        second.encode(into: &bytes)

        let decoded = try Record(bytes: bytes, at: 128, maximumSlotCount: 1_000)
    ...
    @Test func testRecordRejectsAnyFlippedBitInTheChecksummedRange() async throws {
        ...
        let record = Record(uuid: uuidA, documentID: 1, startSlot: 1, endSlot: 2, sequence: 3, flags: [.live])
        ...
        for index in 0..<52 {
            ...
            #expect {
                _ = try Record(bytes: corrupted, at: 0, maximumSlotCount: 1_000)
            } throws: { error in
                switch error {
    ...
    @Test func testRecordRejectsInvertedRange() async throws {
        ...
        var bytes = Record(uuid: uuidA, documentID: 1, startSlot: 0, endSlot: 0, sequence: 1, flags: [.live]).encoded()
        ...
        #expect {
            _ = try Record(bytes: bytes, at: 0, maximumSlotCount: 1_000)
        } throws: { error in
    ...
    @Test func testRecordRejectsRangePastCommittedSlots() async throws {
        ...
        let record = Record(uuid: uuidA, documentID: 1, startSlot: 0, endSlot: 50, sequence: 1, flags: [.live])
        let bytes = record.encoded()

        #expect {
            _ = try Record(bytes: bytes, at: 0, maximumSlotCount: 10)
        } throws: { error in
    ...
    @Test func testRecordAcceptsRangeEndingExactlyAtCommittedSlots() async throws {
        let record = Record(uuid: uuidA, documentID: 1, startSlot: 5, endSlot: 10, sequence: 1, flags: [.live])
        let bytes = record.encoded()

        let decoded = try Record(bytes: bytes, at: 0, maximumSlotCount: 10)
    ...
    @Test func testEmptyRangeIsValidAndLive() async throws {
        ...
        let record = Record(uuid: uuidA, documentID: 1, startSlot: 4, endSlot: 4, sequence: 1, flags: [.live])
        let bytes = record.encoded()
    ...
    @Test func testHeaderRoundTrip() async throws {
        ...
        let decoded = try Header(bytes: bytes)
    ...
    @Test func testSingleRecordLoads() async throws {
        var bytes = Header(generation: 0).encoded()
        Record(uuid: uuidA, documentID: 7, startSlot: 0, endSlot: 3, sequence: 1, flags: [.live])
            .encode(into: &bytes)
    ...
    @Test func testEveryRecordInTheFileIsRead() async throws {
        ...
        for index in 0..<10 {
            ...
            Record(uuid: UUID(), documentID: slot, startSlot: slot, endSlot: slot + 1,
    ...
    @Test func testLastSequenceWinsForTheSameUUID() async throws {
        let created = Record(uuid: uuidA, documentID: 1, startSlot: 0, endSlot: 3, sequence: 1, flags: [.live])
        let updated = Record(uuid: uuidA, documentID: 1, startSlot: 3, endSlot: 8, sequence: 2, flags: [.live])
    ...
    @Test func testFoldUsesSequenceNotFileOrder() async throws {
        ...
        let newer = Record(uuid: uuidA, documentID: 1, startSlot: 9, endSlot: 12, sequence: 5, flags: [.live])
        let older = Record(uuid: uuidA, documentID: 1, startSlot: 0, endSlot: 3, sequence: 2, flags: [.live])
    ...
    @Test func testDeletionRemovesAnEarlierLiveRecord() async throws {
        ...
        let createdA = Record(uuid: uuidA, documentID: 1, startSlot: 0, endSlot: 3, sequence: 1, flags: [.live])
        let createdB = Record(uuid: uuidB, documentID: 2, startSlot: 3, endSlot: 6, sequence: 2, flags: [.live])
        let deletedA = Record(uuid: uuidA, documentID: 1, startSlot: 0, endSlot: 3, sequence: 3, flags: .empty)
    ...
    @Test func testDocumentCanBeResurrectedAfterDeletion() async throws {
        let created = Record(uuid: uuidA, documentID: 1, startSlot: 0, endSlot: 3, sequence: 1, flags: [.live])
        let deleted = Record(uuid: uuidA, documentID: 1, startSlot: 0, endSlot: 3, sequence: 2, flags: .empty)
        let recreated = Record(uuid: uuidA, documentID: 1, startSlot: 6, endSlot: 9, sequence: 3, flags: [.live])
    ...
    @Test func testNextSequenceIsOnePastTheHighestSeen() async throws {
        ...
        let created = Record(uuid: uuidA, documentID: 1, startSlot: 0, endSlot: 3, sequence: 4, flags: [.live])
        let deleted = Record(uuid: uuidA, documentID: 1, startSlot: 0, endSlot: 3, sequence: 9, flags: .empty)
    ...
    @Test func testInvalidRecordIsSkippedWithoutFailingTheLoad() async throws {
        var bytes = Header(generation: 0).encoded()
        Record(uuid: uuidA, documentID: 1, startSlot: 0, endSlot: 3, sequence: 1, flags: [.live])
            .encode(into: &bytes)
        Record(uuid: uuidB, documentID: 2, startSlot: 3, endSlot: 6, sequence: 2, flags: [.live])
            .encode(into: &bytes)
    ...
    @Test func testInvalidRecordDoesNotShadowAGoodEarlierOne() async throws {
        ...
        Record(uuid: uuidA, documentID: 1, startSlot: 0, endSlot: 3, sequence: 1, flags: [.live])
            .encode(into: &bytes)
        Record(uuid: uuidA, documentID: 1, startSlot: 3, endSlot: 8, sequence: 2, flags: [.live])
            .encode(into: &bytes)
    ...
    @Test func testLoadingArbitraryBytesNeverTraps() async throws {
        ...
        for _ in 0..<200 {
            ...
            _ = try? DocumentLog(bytes: bytes, maximumSlotCount: 1_000)
        }
    }
    ...
    @Test func testApplyAddsALiveRecord() async throws {
        let map = DocumentLog(generation: 0)

        map.apply(record: Record(uuid: uuidA, documentID: 3, startSlot: 0, endSlot: 4,
    ...
    @Test func testApplyOfATombstoneRemovesTheEntry() async throws {
        ...
        map.apply(record: Record(uuid: uuidA, documentID: 1, startSlot: 0, endSlot: 3,
                                 sequence: 1, flags: [.live]))
        map.apply(record: Record(uuid: uuidA, documentID: 1, startSlot: 0, endSlot: 3,
    ...
    @Test func testApplyNeverMovesNextSequenceBackwards() async throws {
        ...
        map.apply(record: Record(uuid: uuidB, documentID: 2, startSlot: 3, endSlot: 6,
    ...
    @Test func testEncodeEmitsHeaderPlusOneRecordPerLiveDocument() async throws {
        ...
        Record(uuid: uuidB, documentID: 2, startSlot: 3, endSlot: 6, sequence: 2, flags: [.live])
            .encode(into: &bytes)
        Record(uuid: uuidA, documentID: 1, startSlot: 0, endSlot: 3, sequence: 3, flags: .empty)
            .encode(into: &bytes)
    ...
    @Test func testEncodedMapReloadsWithTheSameRanges() async throws {
        ...
        Record(uuid: uuidA, documentID: 1, startSlot: 0, endSlot: 3, sequence: 1, flags: [.live])
            .encode(into: &bytes)
        Record(uuid: uuidB, documentID: 2, startSlot: 3, endSlot: 9, sequence: 2, flags: [.live])
            .encode(into: &bytes)
    ...
    @Test func testEncodedRecordsAreAllLive() async throws {
        ...
        Record(uuid: uuidA, documentID: 1, startSlot: 0, endSlot: 3, sequence: 1, flags: [.live])
            .encode(into: &bytes)
        Record(uuid: uuidA, documentID: 1, startSlot: 0, endSlot: 3, sequence: 2, flags: .empty)
            .encode(into: &bytes)
        Record(uuid: uuidB, documentID: 2, startSlot: 3, endSlot: 6, sequence: 3, flags: [.live])
            .encode(into: &bytes)
